...
def __cribo_init___cribo_6bb70a_models():
...
def __cribo_init___cribo_3ea006_core_database():
    module = types.SimpleNamespace()
    ...
    _cribo_module_core_database_connection = _cribo_temp_core_database_connection
    ...
    _initialized = _cribo_module_core._initialized
...
def __cribo_init___cribo_a1537c_core_database_connection():
    module = types.SimpleNamespace()
    ...
    _cribo_module_core = core
    CORE_MODEL_VERSION = _cribo_module_core.CORE_MODEL_VERSION
    module.CORE_MODEL_VERSION = CORE_MODEL_VERSION
    _cribo_module_core_database = _cribo_temp_core_database
    _registered_types = _cribo_module_core_database._registered_types
    module._registered_types = _registered_types
    validate_db_name = _cribo_module_core_database.validate_db_name
    module.validate_db_name = validate_db_name
    ...
    def get_connection_info() -> dict:
        ...
        info = {
            "metadata": module.CONNECTION_METADATA,
            "debug_mode": is_debug(),
            "available_validators": [validate_db_name.__name__, __name__],
        }
        if is_debug():
...
def __cribo_init___cribo_7ad5d8_core():
    module = types.SimpleNamespace()
    ...
    _cribo_module_core_database = _cribo_temp_core_database
    db_connect = _cribo_module_core_database.connect
    module.db_connect = db_connect
    __all__ = [
        "initialize_core",
        "validate",
        "get_config",
...
_cribo_temp_models = __cribo_init___cribo_6bb70a_models()
_cribo_temp_core_database_connection = (
    __cribo_init___cribo_a1537c_core_database_connection()
)
_cribo_temp_core_database = __cribo_init___cribo_3ea006_core_database()
_cribo_temp_core = __cribo_init___cribo_7ad5d8_core()
models = _cribo_temp_models
core.database.connection = _cribo_temp_core_database_connection
for attr in dir(_cribo_temp_core_database):
    if not attr.startswith("_"):
        setattr(core.database, attr, getattr(_cribo_temp_core_database, attr))
...
db_connect = _cribo_module_core.db_connect
